import {
    FORGOT_PSWD_FAILED,
    FORGOT_PSWD_REQUEST,
    FORGOT_PSWD_SUCCESS, POST_LOGIN_FAILED, POST_LOGIN_REQUEST, POST_LOGIN_SUCCESS,
    POST_SIGNUP_FAILED, POST_SIGNUP_REQUEST, POST_SIGNUP_SUCCESS,
    RESET_PSWD_FAILED,
    RESET_PSWD_REQUEST,
    RESET_PSWD_SUCCESS,
    USER_LOGGED_IN,
...
import {POST_LOGOUT_FAILED, POST_LOGOUT_REQUEST, POST_LOGOUT_SUCCESS} from "../actions/user";
